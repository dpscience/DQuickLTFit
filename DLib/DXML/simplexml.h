...
public:
    ...
    virtual bool writeToFile(DSimpleXMLNode *rootNode);
    virtual bool writeToFile(const QList<DSimpleXMLNode*>& rootNodeList);
...
public:
    ...
    virtual bool readFromFile(DSimpleXMLTag *xmlContent);
};
