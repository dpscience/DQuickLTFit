...
#ifndef HORIZONTALRANGEDOUBLESLIDER_H
#define HORIZONTALRANGEDOUBLESLIDER_H

#include "../DTypes/types.h"

#define DHorizontalRangeDoubleSlider_WIDGET_MIN   0
#define DHorizontalRangeDoubleSlider_WIDGET_MAX  100


namespace Ui {
class DHorizontalRangeDblSlider;
}

class DHorizontalRangeDblSlider : public QWidget
{
    Q_OBJECT
public:
     typedef enum
...
public:
    explicit DHorizontalRangeDblSlider(QWidget *parent = 0);
    virtual ~DHorizontalRangeDblSlider();
...
private:
    Ui::DHorizontalRangeDblSlider *ui;
...
#endif // HORIZONTALRANGEDOUBLESLIDER_H
